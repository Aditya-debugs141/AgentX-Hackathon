...
export default function MessageBubble({ message, index, isLatest, isTyping }: { message: ChatMessage; index: number; isLatest?: boolean; isTyping?: boolean }) {
  const assistant = message.role === 'assistant';
  const isActive = assistant && isLatest && isTyping;
